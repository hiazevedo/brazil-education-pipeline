...
The 'brazil_education_pipeline' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/brazil_education_pipeline/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] brazil_education_pipeline_etl` to your workspace.
