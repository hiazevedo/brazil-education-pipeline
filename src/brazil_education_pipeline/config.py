...
GOLD_GAP_GENERO           = f"{CATALOG}.{SCHEMA_GOLD}.gap_genero"
GOLD_ALUNO_IMPROVAVEL     = f"{CATALOG}.{SCHEMA_GOLD}.aluno_improvavel"
GOLD_VULNERABILIDADE      = f"{CATALOG}.{SCHEMA_GOLD}.vulnerabilidade_municipal"

ML_FEATURES           = f"{CATALOG}.{SCHEMA_ML}.enem_features"
ML_PREDICTIONS        = f"{CATALOG}.{SCHEMA_ML}.enem_predictions"
ML_MUNICIPIO_CLUSTERS = f"{CATALOG}.{SCHEMA_ML}.municipio_clusters"
